...
void pushArray(int a[], int unsorted, int smallestIndex, int size);
int main()
{
    int a[5];
    int next, size(0);
...
void insertionSort(int a[], int size)
{
    ...
    int nextSmallest, smallestIndex;
...
void pushArray(int a[], int unsorted, int smallestIndex, int size)
{
    int nextSmallest = a[smallestIndex];
